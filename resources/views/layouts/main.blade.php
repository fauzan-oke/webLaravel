...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/input">Input</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/viewTrx">View Transaksi</a>
                        </li>
    ...
    <script>
        ...
        document.getElementById('pilihItem').addEventListener('change', function() {
